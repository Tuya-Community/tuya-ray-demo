...
import { setNavigationBarTitle, Text, View, ScrollView, router } from '@ray-js/ray';
...
export default function Setting() {
  ...
  return (
    <View className={styles.container}>
      <TopBar title={Strings.getLang('setting')} />
      <ScrollView className={styles.scroll} scrollY refresherTriggered={false}>
        <TyCell dataSource={logs} rowKey="title" isRow />
