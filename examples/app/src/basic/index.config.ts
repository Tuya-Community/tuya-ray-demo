...
export const COMPONENTS = [
  ...
  },
  {
    ...
    list: [
      ...
      { name: 'Modal', path: '/basic/modal' },
      { name: 'LinearGradient', path: '/basic/linearGradient' },
      { name: 'RadialGradient', path: '/basic/radialGradient' },
      { name: 'Motion', path: '/basic/motion' },
  ...
  },
  {
    ...
    list: [
      ...
      { name: 'DatePicker', path: '/basic/date-picker' },
      { name: 'TimePicker', path: '/basic/time-picker' },
